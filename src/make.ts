import { basename, dirname, extname, join, resolve } from 'nyxpath'
import fse from 'fs-extra'
import { copyFileWithStream } from './utils/fs'
import type { InputFile, LoaderOptions, OutputFile } from './loader'
import { createLoader } from './loader'
import { getDeclarations } from './utils/dts'

export interface MimikraOptions extends LoaderOptions {
   rootDir?: string
   srcDir?: string
...
export async function mimikra(
   options: MimikraOptions /* istanbul ignore next */ = {},
) {
